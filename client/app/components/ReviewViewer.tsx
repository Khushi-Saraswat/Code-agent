...
import { FaChevronDown, FaChevronRight, FaBug, FaCode, FaChartLine, FaDownload, FaLightbulb, FaShieldAlt } from "react-icons/fa";
...
const ReviewViewer = ({ data, sourceName }: ReviewViewerProps): React.JSX.Element => {
